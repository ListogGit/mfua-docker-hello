...
## 4. Первичная настройка и доступ к интерфейсу
...
При первом запуске Portainer потребует создать начальную учетную запись. Создайте пароль администратора (минимум 8 символов), подтвердите его и нажмите кнопку создания пользователя. 

После успешного создания учетной записи войдите в панель управления под новыми данными.
